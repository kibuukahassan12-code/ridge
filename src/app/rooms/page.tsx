...
export const metadata: Metadata = {
  title: "Rooms & Suites",
  description:
    "Explore Ridge Hotel's 34 rooms and suites in Uganda's Western highlands — private balconies with Rwenzori Mountain views, the natural Uganda-DRC border, and rates that reflect the very best of Ugandan hospitality.",
  ...
  return (
    <>
      <PageHero
        ...
        kicker="Rooms & Suites"
        title="Thirty-Four Rooms, Each With a View"
